...
export const EnvSchema = v.pipe(
  v.object({
    ...
    ...vBranchEnvVars(3).entries,
    ...vBranchEnvVars(4).entries,
    ...vBranchEnvVars(5).entries,
    ...vBranchEnvVars(6).entries,
    ...vBranchEnvVars(7).entries,
  }),
  v.transform((data) => {
    const env = { ...data };
    ...
    for (const index of Array(10).keys()) {
      ...
      let symbol = isCollateralSymbol(env[tokenIdKey])
        ? env[tokenIdKey]
        : null;
